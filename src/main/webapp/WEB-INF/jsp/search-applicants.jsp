...
<body class="custom-background hide-scrollBar">
		...
		<div class="row">
			...
			<div class="col-md-7">
				...
				<div class="col-md-12">
					...
					<ul id="listings" class="agencies"></ul>
				</div>
			</div>
		</div>
	</div>
	...
	<script id="applicant" type="text/x-handlebars-template">
      {{#recs}}
        <li>
			<div class="agency">
				<a href="/recruiter/auth/jobseeker-profile?id={{userName}}"><h3 class="agency-title">{{title}}</h3></a>
	...
	<script>
		...
		function updateSearch() {
			...
			searchApplicants("/recruiter/bydistance", idst, ind);
		}

		function searchApplicants(lookupUrl, dist, ind) {
