...
<body>
		...
		<div class="container">
			<div class="navbar-header">
				<a class="navbar-brand" href="/jobseeker/home" style=""><img
					alt="" src="/img/rshLogo.png" height="40" width="180"> </a>
			</div>
	...
	<section class="section-align">
		...
		<p></p>
		<br>
		<div class="login col-xs-10">
			<form:form method="POST" commandName="jobseeker"
				action="/jobseeker/register" enctype="multipart/form-data">
				...
				<form:input path="phone" class="dinput-lg form-control" id="phone" />
	...
	<footer>
		<div class="container">
			<div id="footer-bottom" class="row">
				<div class="col-md-10">
					<<<<<<< Updated upstream <br> <br> <br> Copyright
					Recruiter Shack &copy; 2016. All Rights Reserved / <a
						class="label-color-font-size" href="/privacy">Privacy</a> / <a
						class="label-color-font-size" href="/terms">Terms</a> 
				</div>
				<div>
